...
:img-build-status: https://dev.azure.com/sonarsource-cfamily-examples/windows-msbuild-azure-sq/_apis/build/status/sonarsource-cfamily-examples.linux-cmake-azure-sq
